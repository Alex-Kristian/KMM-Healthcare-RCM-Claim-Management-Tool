...
// Prompt: "Create a professional looking healthcare claims page for a healthcare revenue cycle management tool. 
// The page must include a table of claim information that is able to be filtered by the different columns. The page must be a React tsx file and use bootstrap"
