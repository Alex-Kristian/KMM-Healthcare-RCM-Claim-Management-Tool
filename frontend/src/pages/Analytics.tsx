// "Create a professional looking payer performance analytics page for a healthcare revenue cycle management tool. The page must include overall payer performance as well as individual payer performance.
// The page must be a React .tsx file and use bootstrap" prompt. Claude, Sonnet 4.6, Anthropic, 13 Mar. 2026, https://claude.ai/.
// Changes made: This page went through quite a bit of refactoring including abstracting components, adding graphs to the page, altering formatting, 
// adding the API get request for claims, and changing statistics displayed 
