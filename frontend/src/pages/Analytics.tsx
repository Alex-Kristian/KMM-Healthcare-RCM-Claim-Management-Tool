...
// Prompt: "Create a professional looking payer performance analytics page for a healthcare revenue cycle management tool. 
// The page must include overall payer performance as well as individual payer performance. The page must be a React tsx file and use bootstrap"
