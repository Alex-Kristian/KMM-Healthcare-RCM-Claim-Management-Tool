...
// Prompt: "Create a professional looking claim denial summary/trends page for a healthcare revenue cycle management tool. 
// The page must display a tbale that gives insights into common service denial codes, what payers are denying claims, and what services are being denied. The page must be a React tsx file and use bootstrap"
