// "Create a professional looking claim denial summary/trends page for a healthcare revenue cycle management tool.  
// The page must display a table that gives insights into common service denial codes, what payers are denying claims, and what services are being denied. 
// The page must be a React .tsx file and use bootstrap" prompt. Claude, Sonnet 4.6,  22 Mar. 2026, https://claude.ai/.
// Changes made: This page went through quite a bit of refactoring including abstracting components, altering formatting to look better and match other pages, 
// adding the API get request for denials, and changing statistics displayed 
